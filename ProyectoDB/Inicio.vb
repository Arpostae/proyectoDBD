...
Public Class Inicio
    ...
    Private Sub Inicio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TabControl.TabPages.Remove(tbModMenu)
        TabControl.TabPages.Remove(tbModEmpleados)
    ...
    Private Sub PictureBox5_Click(sender As Object, e As EventArgs) Handles BtnConfig.Click
        ...
        If IdRol = "1" Then
            MessageBox.Show("Acceso Correcto!", "Usted es administrador!", MessageBoxButtons.OK, MessageBoxIcon.Information)
            TabControl.TabPages.Add(tbModMenu)
            TabControl.TabPages.Add(tbModEmpleados)
        Else
            MessageBox.Show("Acceso Negado!", "Usted no es administrador!", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
